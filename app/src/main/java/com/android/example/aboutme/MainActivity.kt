...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Set a click listener for the nickname_text ... note click listeners are not just for Buttons.
    ...
    private fun addNickname(view: View) {
        // editText variable holds the nickname_edit EditText view (not the text value, but the whole EditText object
        val editText = findViewById<EditText>(R.id.nickname_edit)
        val nicknameTextView = findViewById<TextView>(R.id.nickname_text)

        // use .text to access the text value.
